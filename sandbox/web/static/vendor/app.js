...
var _user$project$SecounterApp$sockerUrl = 'ws://localhost:4000/socket/websocket';
var _user$project$SecounterApp$encodeChannelMsg = function (msg) {
	return A2(
		...
		_elm_lang$core$Json_Encode$object(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					ctor: '_Tuple2',
					_0: 'topic',
					_1: _elm_lang$core$Json_Encode$string(msg.topic)
				},
					{
					ctor: '_Tuple2',
					_0: 'event',
					_1: _elm_lang$core$Json_Encode$string(msg.event)
				},
					{
					ctor: '_Tuple2',
					_0: 'payload',
					_1: _elm_lang$core$Json_Encode$object(
						_elm_lang$core$Native_List.fromArray(
							[
								...
								ctor: '_Tuple2',
								_0: 'body',
								_1: _elm_lang$core$Json_Encode$string(msg.payload)
							}
							]))
				},
					{
					ctor: '_Tuple2',
					_0: 'ref',
					_1: _elm_lang$core$Json_Encode$string(msg.ref)
				}
				])));
};
var _user$project$SecounterApp$sendChannelMsg = function (msg) {
	return A2(
		_elm_lang$websocket$WebSocket$send,
		_user$project$SecounterApp$sockerUrl,
		_user$project$SecounterApp$encodeChannelMsg(msg));
};
var _user$project$SecounterApp$ChannelMsg = F4(
	function (a, b, c, d) {
		return {topic: a, event: b, payload: c, ref: d};
	});
var _user$project$SecounterApp$prepareChannelMsg = F2(
	function (action, counter) {
		return A4(
			_user$project$SecounterApp$ChannelMsg,
			'counter:lobby',
			action,
			_elm_lang$core$Basics$toString(counter),
			action);
	});
var _user$project$SecounterApp$decodeChannelMsg = A5(
...
var _user$project$SecounterApp$Model = F2(
	function (a, b) {
		return {counter: a, message: b};
	});
var _user$project$SecounterApp$update = F2(
	function (msg, _p0) {
		var _p1 = _p0;
		var _p6 = _p1.message;
		var _p5 = _p1.counter;
		...
		switch (_p2.ctor) {
			case 'Join':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$SecounterApp$Model, _p5, _p6),
					_1: _user$project$SecounterApp$sendChannelMsg(
						A4(_user$project$SecounterApp$ChannelMsg, 'counter:lobby', 'phx_join', 'rooms:lobby', 'ui'))
				};
			case 'Increment':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$SecounterApp$Model, _p5, _p6),
					_1: _user$project$SecounterApp$sendChannelMsg(
						A2(_user$project$SecounterApp$prepareChannelMsg, 'increment', _p5))
				};
			case 'Decrement':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$SecounterApp$Model, _p5, _p6),
					_1: _user$project$SecounterApp$sendChannelMsg(
						A2(_user$project$SecounterApp$prepareChannelMsg, 'decrement', _p5))
				};
			default:
				var _p4 = _p2._0;
				var _p3 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$SecounterApp$decodeChannelMsg, _p4);
				if (_p3.ctor === 'Err') {
					return {
						ctor: '_Tuple2',
						_0: A2(
							_user$project$SecounterApp$Model,
							_p5,
							A2(_elm_lang$core$Basics_ops['++'], _p3._0, _p4)),
					...
					return {
						...
						_0: A2(
							...
							A2(
								...
								_p5,
								_elm_lang$core$String$toInt(_p3._0.payload)),
							_p4),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
...
var _user$project$SecounterApp$init = function (action) {
	return A2(
		_user$project$SecounterApp$update,
		action,
		A2(_user$project$SecounterApp$Model, 0, ''));
};
var _user$project$SecounterApp$Receive = function (a) {
	return {ctor: 'Receive', _0: a};
};
var _user$project$SecounterApp$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, _user$project$SecounterApp$sockerUrl, _user$project$SecounterApp$Receive);
};
var _user$project$SecounterApp$Join = {ctor: 'Join'};
var _user$project$SecounterApp$Decrement = {ctor: 'Decrement'};
var _user$project$SecounterApp$Increment = {ctor: 'Increment'};
var _user$project$SecounterApp$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$SecounterApp$Decrement)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$SecounterApp$Increment)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('+')
...
var _user$project$SecounterApp$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _user$project$SecounterApp$init(_user$project$SecounterApp$Join),
			view: _user$project$SecounterApp$view,
			update: _user$project$SecounterApp$update,
			subscriptions: _user$project$SecounterApp$subscriptions
		})
};

var Elm = {};
Elm['SecounterApp'] = Elm['SecounterApp'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['SecounterApp'], 'SecounterApp', typeof _user$project$SecounterApp$main === 'undefined' ? null : _user$project$SecounterApp$main);
